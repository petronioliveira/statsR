...
O próximo passo é investigar dados faltantes (NA) ou valores vazios[^2] em cada conjunto separadamente. Isso garante que o tratamento seja feito corretamente sem contaminar o teste.

[^2]: Deve-se fazer isso, pois algumas vezes, o R não interpreta espaços vazios como NA.
...
Além de observar visualmente, pode-se realizar um teste estatístico (Teste de Delong) para verificar se a diferença entre as AUCs das curvas tem significância estatística:
